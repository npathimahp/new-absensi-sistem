...
# Memuat Tampilan Latar Belakang dan Mode
...
# memuat encoding wajah dan ID mahasiswa untuk mencocokkan wajah yang dikenali.
...
while True:
    ...
    imgSmall = cv2.cvtColor(imgSmall, cv2.COLOR_BGR2RGB)  # Pengenalan Wajah
    ...
    if faceCurrentFrame:
        for encodeFace, faceLocation in zip(encodeCurrentFrame, faceCurrentFrame):
            ...
            if matches[matchIndex] == True:
                ...
                if counter == 0:
                    cvzone.putTextRect(
                        imgBackground, "Mendeteksi Wajah", (65, 200), thickness=2
                    )
                ...
                cv2.waitKey(3)
                cvzone.putTextRect(
                    imgBackground, "Wajah Tidak Terdeteksi", (65, 200), thickness=2
                )
                modeType = 4
                counter = 0
                imgBackground[44 : 44 + 633, 808 : 808 + 414] = imgModeList[modeType]
        ...
        if counter != 0:
            if counter == 1:
                ...
                blob = bucket.get_blob(f"./app/static/Files/Images/{id}.jpg")
